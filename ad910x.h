...
{
    public:
        #pragma region (Multi-Board Sync Code)
        SPI( spi );             /// SPI instance of AD910x
        DigitalOut( csb1 );     /// DigitalOut instance for AD910x device 1 chip select
        DigitalOut( csb2 );     /// DigitalOut instance for AD910x device 2 chip select
        DigitalOut( resetb );   /// DigitalOut instance for AD910x reset pin
        DigitalOut( triggerb ); /// DigitalOut instance for AD910x trigger pin
